...
def planner_claude(query, tool_defs, model: str = "anthropic:claude-haiku-4-5") -> str: 
    ...
    If the emails involve any time duration from today, then you need to find today's date.

    If you need to search for emails, you may have to search by the sender or subject or content too.
